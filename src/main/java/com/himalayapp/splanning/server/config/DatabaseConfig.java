package com.himalayapp.splanning.server.config;
...
@Configuration
@EnableJpaRepositories("com.himalayapp.splanning.server.repository")
@EnableTransactionManagement
@ComponentScan("com.himalayapp.splanning.server.repository")
